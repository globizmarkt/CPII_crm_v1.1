...
const translations = {
    pt: {
        ...
        // ── GADGETS: placeholders Órbita 1 (REBORN-02.2) ────────────────
        "system.status.in_construction":            "Em construção · Sprint futuro",

        // ── GADGET: cpii_compliance_dashboard (REBORN-02.2) ──────────────
        "system_status":                            "Operacional v2.4",
        "nav_overview":                             "Overview",
        "nav_alerts":                               "Alertas de Compliance",
        "nav_reports":                              "Relatórios IMPIC",
        "nav_audit":                                "Registo de Auditoria",
        "nav_settings":                             "Configurações",
        "cta_generate":                             "Gerar Relatório",
        "user_name":                                "Alex Rivera",
        "user_role":                                "Compliance Lead",
        "btn_filter":                               "Filtrar",
        "compliance.dashboard.title":               "Dashboard de Compliance",
        "compliance.dashboard.subtitle":            "Estado operativo, risco AML/BCFT e reportes ao IMPIC",
        "compliance.filter.dias_30":                "30 dias",
        "metric_integrity_trend":                   "+12%",
        "metric_integrity":                         "Índice de Integridade",
        "high_priority":                            "Crítico",
        "metric_active_alerts":                     "Alertas Activas",
        "metric_impic_pending_count":               "2 Pendentes",
        "compliance.kpi.impic_pending":             "Reportes IMPIC pendentes",
        "metric_latency_status":                    "Estável",
        "metric_latency":                           "Latência de Auditoria",
        "section_alerts":                           "Alertas de Compliance",
        "view_all":                                 "Ver tudo",
        "empty_alerts_title":                       "Sem alertas pendentes",
        "empty_alerts_desc":                        "Todos os sistemas estão a operar dentro dos parâmetros de cumprimento R2 estabelecidos.",
        "btn_scan":                                 "Escanear Agora",
        "section_impic":                            "Relatórios IMPIC",
        "empty_reports_title":                      "Nenhum reporte encontrado",
        "empty_reports_desc":                       "Inicie o processo de auditoria para gerar documentos IMPIC.",
        "compliance.action.generate_impic_report":  "Gerar relatório IMPIC",
        "collaborators":                            "2 Colaboradores online",
        "section_activity":                         "Atividade de Auditoria Recente",
        "th_event":                                 "Evento",
        "th_origin":                                "Origem",
        "th_status":                                "Estado",
        "th_time":                                  "Timestamp",
        "event_1":                                  "Sincronização de Base de Dados R2",
        "status_ok":                                "Êxito",
        "time_4_mins_ago":                          "Há 4 mins",
        "event_2":                                  "Validação de Token de Acesso",
        "status_progress":                          "A processar",
        "time_12_mins_ago":                         "Há 12 mins",
        "event_3":                                  "Backup Semanal de Logins",
        "status_queued":                            "Em Fila",
        "time_1_hour_ago":                          "Há 1 hora",
        "copyright":                                "© 2026 CPII COMPLIANCE SYSTEMS. Todos os direitos reservados.",
        "footer_privacy":                           "Privacidade",
        "footer_terms":                             "Termos R2-D4",
        "footer_support":                           "Suporte",

        // ── GADGET: cpii_market (REBORN-02.2) ───────────────────────────
        "portal_subtitle":                          "Market Intelligence Portal",
        "nav_yield":                                "Yield Intelligence",
        "nav_simulator":                            "Simulador",
        "nav_feed":                                 "Feed de Mercado",
        "euribor_status":                           "EURIBOR 12M",
        "overview_title":                           "Visão Geral do Mercado",
        "overview_desc":                            "Indicadores em tempo real do mercado imobiliário português",
        "kpi_price_label":                          "Preço Médio m²",
        "kpi_time_label":                           "Tempo de Venda",
        "market.kpi.yield_status_stable":           "Estável",
        "kpi_yield_label":                          "Yield Bruta",
        "kpi_effort_label":                         "Taxa de Esforço",
        "kpi_euribor_label":                        "Euribor 12M",
        "trend_chart_title":                        "Tendência de Preços — Lisboa",
        "month.jan":                                "Jan",
        "month.mar":                                "Mar",
        "month.mai":                                "Mai",
        "month.jul":                                "Jul",
        "month.set":                                "Set",
        "month.nov":                                "Nov",
        "market_snapshot_title":                    "Instantâneo do Mercado",
        "market.snapshot.lisbon.zone":              "Zona Histórica",
        "market.snapshot.lisbon.trend":             "Em alta +0.8%",
        "market.snapshot.porto.zone":               "Marginal",
        "market.snapshot.porto.trend":              "Em alta +1.2%",
        "yield_title":                              "Yield Intelligence",
        "yield_desc":                               "Análise profunda de rentabilidade por zona e tipologia",
        "neighborhood_rank_title":                  "Ranking de Bairros por Yield",
        "market.ranking.arroios.descriptor":        "Zentral/Cultural",
        "market.ranking.col_price_sqm":             "Preço m²",
        "market.ranking.col_yield":                 "Yield",
        "market.ranking.marvila.descriptor":        "Industrial Chic",
        "market.ranking.campolide.descriptor":      "Prime Residence",
        "typology_title":                           "Performance por Tipologia",
        "market.typology.badge.hot":                "Hot Asset",
        "market.typology.col_rent_avg":             "Renda Média",
        "market.typology.col_yield_gross":          "Yield Bruta",
        "market.typology.badge.balanced":           "Balanced",
        "market.typology.badge.low_yield":          "Low Yield",
        "simulator_title":                          "Simulador de Yield",
        "simulator_desc":                           "Projete a rentabilidade do seu investimento imobiliário",
        "group_property_income":                    "Aquisição & Rendimento",
        "input_purchase_price":                     "Preço de Aquisição (€)",
        "input_monthly_rent":                       "Renda Mensal Estimada (€)",
        "group_financing":                          "Financiamento",
        "input_lvt":                                "LTV (%)",
        "input_interest":                           "Taxa de Juro (%)",
        "input_term":                               "Prazo (Anos)",
        "group_operational":                        "Custos Operacionais",
        "input_condo_tax":                          "Condomínio & IMI (€/mês)",
        "input_management":                         "Gestão (8% Renda)",
        "results_panel_title":                      "Análise de Retorno",
        "result_gross_yield":                       "Yield Bruta",
        "result_net_yield":                         "Yield Líquida",
        "result_monthly_cashflow":                  "Cash Flow Mensal",
        "result_break_even":                        "Break Even (Anos)",
        "cta_generate_pdf":                         "Exportar PDF",
        "feed_title":                               "Feed de Mercado",
        "feed_desc":                                "Notícias e alertas em tempo real",
        "market.feed.time_2h":                      "Há 2 horas",
        "market.feed.impact_positive":              "Impacto Positivo",
        "market.feed.time_5h":                      "Há 5 horas",
        "market.feed.alert_legislative":            "Alerta Legislativo",
        "market.feed.time_1d":                      "Há 1 dia",
        "market.feed.impact_neutral":               "Neutro",
        "alerts_title":                             "Alertas de Ativos",
        "empty_saved_searches":                     "Sem pesquisas guardadas",
        "market.empty.saved_searches_desc":         "As suas monitorizações personalizadas",
    ...
    es: {
        ...
        // ── GADGETS: placeholders Órbita 1 (REBORN-02.2) ────────────────
        "system.status.in_construction":            "En construcción · Sprint futuro",

        // ── GADGET: cpii_compliance_dashboard (REBORN-02.2) ──────────────
        "system_status":                            "Operacional v2.4",
        "nav_overview":                             "Visión General",
        "nav_alerts":                               "Alertas de Compliance",
        "nav_reports":                              "Reportes IMPIC",
        "nav_audit":                                "Registros de Auditoría",
        "nav_settings":                             "Configuración",
        "cta_generate":                             "Generar Informe",
        "user_name":                                "Alex Rivera",
        "user_role":                                "Responsable de Compliance",
        "btn_filter":                               "Filtrar",
        "compliance.dashboard.title":               "Dashboard de Compliance",
        "compliance.dashboard.subtitle":            "Estado operativo, riesgo AML/BCFT y reportes al IMPIC",
        "compliance.filter.dias_30":                "30 días",
        "metric_integrity_trend":                   "+12%",
        "metric_integrity":                         "Índice de Integridad",
        "high_priority":                            "Crítico",
        "metric_active_alerts":                     "Alertas Activas",
        "metric_impic_pending_count":               "2 Pendientes",
        "compliance.kpi.impic_pending":             "Reportes IMPIC pendientes",
        "metric_latency_status":                    "Estable",
        "metric_latency":                           "Latencia de Auditoría",
        "section_alerts":                           "Alertas de Compliance",
        "view_all":                                 "Ver todo",
        "empty_alerts_title":                       "Sin alertas pendientes",
        "empty_alerts_desc":                        "Todos los sistemas operan dentro de los parámetros de cumplimiento R2 establecidos.",
        "btn_scan":                                 "Escanear Ahora",
        "section_impic":                            "Reportes IMPIC",
        "empty_reports_title":                      "Ningún reporte encontrado",
        "empty_reports_desc":                       "Inicie el proceso de auditoría para generar documentos IMPIC.",
        "compliance.action.generate_impic_report":  "Generar reporte IMPIC",
        "collaborators":                            "2 Colaboradores en línea",
        "section_activity":                         "Actividad de Auditoría Reciente",
        "th_event":                                 "Evento",
        "th_origin":                                "Origen",
        "th_status":                                "Estado",
        "th_time":                                  "Marca de Tiempo",
        "event_1":                                  "Sincronización de Base de Datos R2",
        "status_ok":                                "Éxito",
        "time_4_mins_ago":                          "Hace 4 mins",
        "event_2":                                  "Validación de Token de Acceso",
        "status_progress":                          "Procesando",
        "time_12_mins_ago":                         "Hace 12 mins",
        "event_3":                                  "Backup Semanal de Logins",
        "status_queued":                            "En Cola",
        "time_1_hour_ago":                          "Hace 1 hora",
        "copyright":                                "© 2026 CPII COMPLIANCE SYSTEMS. Todos los derechos reservados.",
        "footer_privacy":                           "Privacidad",
        "footer_terms":                             "Términos R2-D4",
        "footer_support":                           "Soporte",

        // ── GADGET: cpii_market (REBORN-02.2) ───────────────────────────
        "portal_subtitle":                          "Portal de Inteligencia de Mercado",
        "nav_yield":                                "Yield Intelligence",
        "nav_simulator":                            "Simulador",
        "nav_feed":                                 "Feed de Mercado",
        "euribor_status":                           "EURIBOR 12M",
        "overview_title":                           "Visión General del Mercado",
        "overview_desc":                            "Indicadores en tiempo real del mercado inmobiliario portugués",
        "kpi_price_label":                          "Precio Medio m²",
        "kpi_time_label":                           "Tiempo de Venta",
        "market.kpi.yield_status_stable":           "Estable",
        "kpi_yield_label":                          "Yield Bruta",
        "kpi_effort_label":                         "Tasa de Esfuerzo",
        "kpi_euribor_label":                        "Euribor 12M",
        "trend_chart_title":                        "Tendencia de Precios — Lisboa",
        "month.jan":                                "Ene",
        "month.mar":                                "Mar",
        "month.mai":                                "May",
        "month.jul":                                "Jul",
        "month.set":                                "Sep",
        "month.nov":                                "Nov",
        "market_snapshot_title":                    "Instantánea del Mercado",
        "market.snapshot.lisbon.zone":              "Zona Histórica",
        "market.snapshot.lisbon.trend":             "Al alza +0.8%",
        "market.snapshot.porto.zone":               "Marginal",
        "market.snapshot.porto.trend":              "Al alza +1.2%",
        "yield_title":                              "Yield Intelligence",
        "yield_desc":                               "Análisis profundo de rentabilidad por zona y tipología",
        "neighborhood_rank_title":                  "Ranking de Barrios por Yield",
        "market.ranking.arroios.descriptor":        "Zentral/Cultural",
        "market.ranking.col_price_sqm":             "Precio m²",
        "market.ranking.col_yield":                 "Yield",
        "market.ranking.marvila.descriptor":        "Industrial Chic",
        "market.ranking.campolide.descriptor":      "Prime Residence",
        "typology_title":                           "Rendimiento por Tipología",
        "market.typology.badge.hot":                "Activo Caliente",
        "market.typology.col_rent_avg":             "Renta Media",
        "market.typology.col_yield_gross":          "Yield Bruta",
        "market.typology.badge.balanced":           "Equilibrado",
        "market.typology.badge.low_yield":          "Bajo Rendimiento",
        "simulator_title":                          "Simulador de Yield",
        "simulator_desc":                           "Proyecte la rentabilidad de su inversión inmobiliaria",
        "group_property_income":                    "Adquisición & Rendimiento",
        "input_purchase_price":                     "Precio de Adquisición (€)",
        "input_monthly_rent":                       "Renta Mensual Estimada (€)",
        "group_financing":                          "Financiamiento",
        "input_lvt":                                "LTV (%)",
        "input_interest":                           "Tasa de Interés (%)",
        "input_term":                               "Plazo (Años)",
        "group_operational":                        "Costos Operacionales",
        "input_condo_tax":                          "Condominio & IMI (€/mes)",
        "input_management":                         "Gestión (8% Renta)",
        "results_panel_title":                      "Análisis de Retorno",
        "result_gross_yield":                       "Yield Bruta",
        "result_net_yield":                         "Yield Neta",
        "result_monthly_cashflow":                  "Flujo de Caja Mensual",
        "result_break_even":                        "Break Even (Años)",
        "cta_generate_pdf":                         "Exportar PDF",
        "feed_title":                               "Feed de Mercado",
        "feed_desc":                                "Noticias y alertas en tiempo real",
        "market.feed.time_2h":                      "Hace 2 horas",
        "market.feed.impact_positive":              "Impacto Positivo",
        "market.feed.time_5h":                      "Hace 5 horas",
        "market.feed.alert_legislative":            "Alerta Legislativa",
        "market.feed.time_1d":                      "Hace 1 día",
        "market.feed.impact_neutral":               "Neutro",
        "alerts_title":                             "Alertas de Activos",
        "empty_saved_searches":                     "Sin búsquedas guardadas",
        "market.empty.saved_searches_desc":         "Sus monitorizaciones personalizadas",
    ...
    en: {
        ...
        // ── GADGETS: placeholders Órbita 1 (REBORN-02.2) ────────────────
        "system.status.in_construction":            "Under construction · Future sprint",

        // ── GADGET: cpii_compliance_dashboard (REBORN-02.2) ──────────────
        "system_status":                            "Operational v2.4",
        "nav_overview":                             "Overview",
        "nav_alerts":                               "Compliance Alerts",
        "nav_reports":                              "IMPIC Reports",
        "nav_audit":                                "Audit Logs",
        "nav_settings":                             "Settings",
        "cta_generate":                             "Generate Report",
        "user_name":                                "Alex Rivera",
        "user_role":                                "Compliance Lead",
        "btn_filter":                               "Filter",
        "compliance.dashboard.title":               "Compliance Dashboard",
        "compliance.dashboard.subtitle":            "Operational status, AML/BCFT risk and IMPIC reports",
        "compliance.filter.dias_30":                "30 days",
        "metric_integrity_trend":                   "+12%",
        "metric_integrity":                         "Integrity Index",
        "high_priority":                            "Critical",
        "metric_active_alerts":                     "Active Alerts",
        "metric_impic_pending_count":               "2 Pending",
        "compliance.kpi.impic_pending":             "Pending IMPIC Reports",
        "metric_latency_status":                    "Stable",
        "metric_latency":                           "Audit Latency",
        "section_alerts":                           "Compliance Alerts",
        "view_all":                                 "View all",
        "empty_alerts_title":                       "No pending alerts",
        "empty_alerts_desc":                        "All systems are operating within established R2 compliance parameters.",
        "btn_scan":                                 "Scan Now",
        "section_impic":                            "IMPIC Reports",
        "empty_reports_title":                      "No reports found",
        "empty_reports_desc":                       "Start the audit process to generate IMPIC documents.",
        "compliance.action.generate_impic_report":  "Generate IMPIC report",
        "collaborators":                            "2 Collaborators online",
        "section_activity":                         "Recent Audit Activity",
        "th_event":                                 "Event",
        "th_origin":                                "Origin",
        "th_status":                                "Status",
        "th_time":                                  "Timestamp",
        "event_1":                                  "R2 Database Synchronization",
        "status_ok":                                "Success",
        "time_4_mins_ago":                          "4 mins ago",
        "event_2":                                  "Access Token Validation",
        "status_progress":                          "Processing",
        "time_12_mins_ago":                         "12 mins ago",
        "event_3":                                  "Weekly Login Backup",
        "status_queued":                            "Queued",
        "time_1_hour_ago":                          "1 hour ago",
        "copyright":                                "© 2026 CPII COMPLIANCE SYSTEMS. All rights reserved.",
        "footer_privacy":                           "Privacy",
        "footer_terms":                             "Terms R2-D4",
        ...
        "nav_feed":                                 "Market Feed",
        "euribor_status":                           "EURIBOR 12M",
        "overview_title":                           "Market Overview",
        "overview_desc":                            "Real-time indicators for the Portuguese real estate market",
        "kpi_price_label":                          "Avg Price m²",
        "kpi_time_label":                           "Time to Sell",
        "market.kpi.yield_status_stable":           "Stable",
        "kpi_yield_label":                          "Gross Yield",
        "kpi_effort_label":                         "Effort Rate",
        "kpi_euribor_label":                        "Euribor 12M",
        "trend_chart_title":                        "Price Trend — Lisbon",
        "month.jan":                                "Jan",
        "month.mar":                                "Mar",
        "month.mai":                                "May",
        "month.jul":                                "Jul",
        ...
        "market.snapshot.lisbon.zone":              "Historic Zone",
        "market.snapshot.lisbon.trend":             "Rising +0.8%",
        "market.snapshot.porto.zone":               "Waterfront",
        "market.snapshot.porto.trend":              "Rising +1.2%",
        "yield_title":                              "Yield Intelligence",
        "yield_desc":                               "Deep yield analysis by zone and typology",
        "neighborhood_rank_title":                  "Neighborhood Yield Ranking",
        "market.ranking.arroios.descriptor":        "Cultural/Central",
        "market.ranking.col_price_sqm":             "Price m²",
        "market.ranking.col_yield":                 "Yield",
        "market.ranking.marvila.descriptor":        "Industrial Chic",
        "market.ranking.campolide.descriptor":      "Prime Residence",
        "typology_title":                           "Performance by Typology",
        "market.typology.badge.hot":                "Hot Asset",
        "market.typology.col_rent_avg":             "Avg Rent",
        "market.typology.col_yield_gross":          "Gross Yield",
        "market.typology.badge.balanced":           "Balanced",
        "market.typology.badge.low_yield":          "Low Yield",
        "simulator_title":                          "Yield Simulator",
        "simulator_desc":                           "Project the profitability of your real estate investment",
        "group_property_income":                    "Acquisition & Income",
        "input_purchase_price":                     "Purchase Price (€)",
        "input_monthly_rent":                       "Estimated Monthly Rent (€)",
        "group_financing":                          "Financing",
        "input_lvt":                                "LTV (%)",
        "input_interest":                           "Interest Rate (%)",
        "input_term":                               "Term (Years)",
        "group_operational":                        "Operational Costs",
        "input_condo_tax":                          "Condo & IMI (€/month)",
        "input_management":                         "Management (8% Rent)",
        "results_panel_title":                      "Return Analysis",
        "result_gross_yield":                       "Gross Yield",
        "result_net_yield":                         "Net Yield",
        "result_monthly_cashflow":                  "Monthly Cash Flow",
        "result_break_even":                        "Break Even (Years)",
        "cta_generate_pdf":                         "Export PDF",
        "feed_title":                               "Market Feed",
        "feed_desc":                                "Real-time news and alerts",
        "market.feed.time_2h":                      "2 hours ago",
        "market.feed.impact_positive":              "Positive Impact",
        "market.feed.time_5h":                      "5 hours ago",
        "market.feed.alert_legislative":            "Legislative Alert",
        "market.feed.time_1d":                      "1 day ago",
        "market.feed.impact_neutral":               "Neutral",
        "alerts_title":                             "Asset Alerts",
        "empty_saved_searches":                     "No saved searches",
        "market.empty.saved_searches_desc":         "Your personalized monitors",
    ...
    fr: {
        ...
        // ── GADGETS: placeholders Órbita 1 (REBORN-02.2) ────────────────
        "system.status.in_construction":            "En cours de construction · Sprint futur",

        // ── GADGET: cpii_compliance_dashboard (REBORN-02.2) ──────────────
        "system_status":                            "Opérationnel v2.4",
        "nav_overview":                             "Vue d'ensemble",
        "nav_alerts":                               "Alertes Compliance",
        "nav_reports":                              "Rapports IMPIC",
        "nav_audit":                                "Journaux d'Audit",
        "nav_settings":                             "Paramètres",
        "cta_generate":                             "Générer Rapport",
        "user_name":                                "Alex Rivera",
        "user_role":                                "Responsable Compliance",
        "btn_filter":                               "Filtrer",
        "compliance.dashboard.title":               "Tableau de Bord Compliance",
        "compliance.dashboard.subtitle":            "État opérationnel, risque AML/BCFT et rapports IMPIC",
        "compliance.filter.dias_30":                "30 jours",
        "metric_integrity_trend":                   "+12%",
        "metric_integrity":                         "Indice d'Intégrité",
        "high_priority":                            "Critique",
        "metric_active_alerts":                     "Alertes Actives",
        "metric_impic_pending_count":               "2 En attente",
        "compliance.kpi.impic_pending":             "Rapports IMPIC en attente",
        "metric_latency_status":                    "Stable",
        "metric_latency":                           "Latence d'Audit",
        "section_alerts":                           "Alertes Compliance",
        "view_all":                                 "Voir tout",
        "empty_alerts_title":                       "Aucune alerte en attente",
        "empty_alerts_desc":                        "Tous les systèmes fonctionnent dans les paramètres de conformité R2 établis.",
        "btn_scan":                                 "Scanner Maintenant",
        "section_impic":                            "Rapports IMPIC",
        "empty_reports_title":                      "Aucun rapport trouvé",
        "empty_reports_desc":                       "Démarrez le processus d'audit pour générer des documents IMPIC.",
        "compliance.action.generate_impic_report":  "Générer rapport IMPIC",
        "collaborators":                            "2 Collaborateurs en ligne",
        "section_activity":                         "Activité d'Audit Récente",
        "th_event":                                 "Événement",
        "th_origin":                                "Origine",
        "th_status":                                "Statut",
        "th_time":                                  "Horodatage",
        "event_1":                                  "Synchronisation Base de Données R2",
        "status_ok":                                "Succès",
        "time_4_mins_ago":                          "Il y a 4 min",
        "event_2":                                  "Validation de Token d'Accès",
        "status_progress":                          "En cours",
        "time_12_mins_ago":                         "Il y a 12 min",
        "event_3":                                  "Sauvegarde Hebdomadaire des Connexions",
        "status_queued":                            "En file",
        "time_1_hour_ago":                          "Il y a 1 heure",
        "copyright":                                "© 2026 CPII COMPLIANCE SYSTEMS. Tous droits réservés.",
        "footer_privacy":                           "Confidentialité",
        "footer_terms":                             "Conditions R2-D4",
        "footer_support":                           "Assistance",

        // ── GADGET: cpii_market (REBORN-02.2) ───────────────────────────
        "portal_subtitle":                          "Portail Intelligence Marché",
        "nav_yield":                                "Yield Intelligence",
        "nav_simulator":                            "Simulateur",
        "nav_feed":                                 "Flux Marché",
        "euribor_status":                           "EURIBOR 12M",
        "overview_title":                           "Vue Générale du Marché",
        "overview_desc":                            "Indicateurs en temps réel du marché immobilier portugais",
        "kpi_price_label":                          "Prix Moyen m²",
        "kpi_time_label":                           "Temps de Vente",
        "market.kpi.yield_status_stable":           "Stable",
        "kpi_yield_label":                          "Rendement Brut",
        "kpi_effort_label":                         "Taux d'Effort",
        "kpi_euribor_label":                        "Euribor 12M",
        "trend_chart_title":                        "Tendance des Prix — Lisbonne",
        "month.jan":                                "Jan",
        "month.mar":                                "Mar",
        "month.mai":                                "Mai",
        "month.jul":                                "Jui",
        "month.set":                                "Sep",
        "month.nov":                                "Nov",
        "market_snapshot_title":                    "Instantané du Marché",
        "market.snapshot.lisbon.zone":              "Zone Historique",
        "market.snapshot.lisbon.trend":             "En hausse +0.8%",
        "market.snapshot.porto.zone":               "Marginal",
        "market.snapshot.porto.trend":              "En hausse +1.2%",
        "yield_title":                              "Yield Intelligence",
        "yield_desc":                               "Analyse approfondie de rentabilité par zone et typologie",
        "neighborhood_rank_title":                  "Classement des Quartiers par Yield",
        "market.ranking.arroios.descriptor":        "Central/Culturel",
        "market.ranking.col_price_sqm":             "Prix m²",
        "market.ranking.col_yield":                 "Yield",
        "market.ranking.marvila.descriptor":        "Industrial Chic",
        "market.ranking.campolide.descriptor":      "Résidence Premium",
        "typology_title":                           "Performance par Typologie",
        "market.typology.badge.hot":                "Actif Chaud",
        "market.typology.col_rent_avg":             "Loyer Moyen",
        "market.typology.col_yield_gross":          "Rendement Brut",
        "market.typology.badge.balanced":           "Équilibré",
        "market.typology.badge.low_yield":          "Faible Rendement",
        "simulator_title":                          "Simulateur de Yield",
        "simulator_desc":                           "Projetez la rentabilité de votre investissement immobilier",
        "group_property_income":                    "Acquisition & Revenus",
        "input_purchase_price":                     "Prix d'Acquisition (€)",
        "input_monthly_rent":                       "Loyer Mensuel Estimé (€)",
        "group_financing":                          "Financement",
        "input_lvt":                                "LTV (%)",
        "input_interest":                           "Taux d'Intérêt (%)",
        "input_term":                               "Durée (Années)",
        "group_operational":                        "Coûts Opérationnels",
        "input_condo_tax":                          "Charges & IMI (€/mois)",
        "input_management":                         "Gestion (8% Loyer)",
        "results_panel_title":                      "Analyse de Rendement",
        "result_gross_yield":                       "Rendement Brut",
        "result_net_yield":                         "Rendement Net",
        "result_monthly_cashflow":                  "Flux de Trésorerie Mensuel",
        "result_break_even":                        "Seuil de Rentabilité (Années)",
        "cta_generate_pdf":                         "Exporter PDF",
        "feed_title":                               "Flux Marché",
        "feed_desc":                                "Actualités et alertes en temps réel",
        "market.feed.time_2h":                      "Il y a 2 heures",
        "market.feed.impact_positive":              "Impact Positif",
        "market.feed.time_5h":                      "Il y a 5 heures",
        "market.feed.alert_legislative":            "Alerte Législative",
        "market.feed.time_1d":                      "Il y a 1 jour",
        "market.feed.impact_neutral":               "Neutre",
        "alerts_title":                             "Alertes d'Actifs",
        "empty_saved_searches":                     "Aucune recherche sauvegardée",
        "market.empty.saved_searches_desc":         "Vos surveillances personnalisées",
